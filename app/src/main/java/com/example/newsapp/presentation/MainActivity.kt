...
import com.example.newsapp.presentation.newDetails.NewsDetailsScreen
...
sealed class NavScreen(val route: String, val icon: ImageVector, val title: String) {
    data object Home : NavScreen("/home", Icons.Filled.Home, "Home")
    data object Bookmarks : NavScreen("/bookmarks", Icons.Filled.Favorite, "Bookmarks")
}
